...
@app.get('/get_auto_process_rules')
...
@app.post('/update_auto_process_rules')
...
@app.delete('/delete_auto_process_rules')
...
@app.get('/get_auto_process_items')
...
@app.post('/update_auto_process_items')
...
@app.delete('/delete_auto_process_items')
